...
<?php
  ...
  //-------------------------- 新增 ------------------------------
     ...
     if (!empty($_FILES['aPic']['name'])) {
        ...
        ecstart_convert_jpeg($_FILES['aPic']['tmp_name'], '../../img/'.$aPic, 'N','N','N','N',1900);
      }
      else{
        $aPic='';
      }
		...
		<div class="col-lg-9">
            ...
            <div class="form-group">
              ...
              <div class="col-md-4">
                ...
                <span class="text-danger">圖片規格:1903*711</span>
							</div>
						</div>
                  ...
                  <input type="hidden" id="old_img" value="<?php echo $row['aPic'];?>">
								</div>
							</div>
						<?php }?>
						</div>
            ...
            <?php }?>
						...
						<div id="use_web_div" class="form-group">
							...
							<div class="col-md-10">
								<input type="text" class="form-control" id="use_web" name="use_web" value="<?php echo $use_web=empty($row['use_web']) ? 'article_list.php': $row['use_web'];?>">
							</div>
						</div>
