		...
		<div class="col-lg-9">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form id="put_form" action="img_test.php" method="POST" enctype='multipart/form-data' class="form-horizontal">
            ...
            <div class="form-group">
              <label class="col-md-2 control-label" for="aPic">TEST代表圖檔</label>
              <div class="col-md-10">
                <input type="file"  class="form-control" accept=".jpg" id="test_img" >
              </div>
            </div>
...
<script type="text/javascript">
    ...
    //-- 選擇圖檔 --
      $('#test_img').change(function(event) {
