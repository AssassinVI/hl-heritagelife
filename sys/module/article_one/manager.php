	...
	<div class="row">
		<div class="col-lg-9">
						...
						<div style="display: none;" class="form-group ">
							...
							<div class="col-md-10 recommend_div">
								...
								<?php
								  ...
								  // $sql=$pdo->prepare("SELECT Tb_index, aTitle FROM appArticle WHERE mt_id=:mt_id AND Tb_index!=:Tb_index ORDER BY OrderBy DESC, StartDate DESC, Tb_index DESC");
          ...
          //                         }
                        ...
                        <!-- 關閉欄位 -->
                        <!-- 關閉欄位 -->
						<div style="display: none;" id="search_div" class="form-group">
            ...
            <!-- 關閉欄位 -->
						...
						<input type="hidden" id="art_label" name="art_label" value="<?php echo $row['label'];?>">
