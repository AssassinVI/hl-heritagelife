				...
				<div class="panel-body">
					<form id="put_form" action="manager.php" method="POST" enctype='multipart/form-data' class="form-horizontal">
						<div class="form-group">
							<label class="col-md-2 control-label" for="label_name">標簽名稱</label>
							<div class="col-md-10">
								<input type="text" class="form-control" id="label_name" name="label_name" value="<?php echo $row['label_name'];?>">
							</div>
						</div>
