  ...
  // ======================== 刪除 ===========================
    ...
    if (!empty($_POST['type']) && $_POST['type']=='delete') { 
    	if (!empty($_POST['aPic'])) {
            ...
            pdo_update('appNumber', $param, $where);
            unlink('../../img/'.$_POST['aPic']);
    	}else{
        //----------------------- 多檔刪除 -------------------------------
    		$sel_where=['Tb_index'=>$_POST['Tb_index']];
    		$otr_file=pdo_select('SELECT OtherFile FROM appNumber WHERE Tb_index=:Tb_index', $sel_where);
	...
	location_up('admin.php?MT_id='.$_POST['mt_id'],'成功新增');
      ...
      if (!empty($_FILES['aPic']['name'])) {
        ...
        pdo_update('appNumber', $aPic_param, $aPic_where);
      ...
      if (!empty($_FILES['OtherFile']['name'][0])) {
      	...
      	$now_file =pdo_select("SELECT OtherFile FROM appNumber WHERE Tb_index=:Tb_index", $sel_where);
        ...
        pdo_update('appNumber', $OtherFile_param, $OtherFile_where);
      }
      	//--------------------------- END -----------------------------------
...
if ($_GET) {
 	...
 	$row=pdo_select('SELECT * FROM appNumber WHERE Tb_index=:Tb_index', $where);
}
?>
...
<div class="wrapper wrapper-content animated fadeInRight">
	<div class="row">
		<div class="col-lg-9">
				...
				<div class="panel-body">
					<form id="put_form" action="manager.php" method="POST" enctype='multipart/form-data' class="form-horizontal">
						<div class="form-group">
							<label class="col-md-2 control-label" for="aTitle">編號名稱</label>
							<div class="col-md-10">
            ...
            <div class="form-group">
              <label class="col-md-2 control-label" for="code">代表流水號</label>
              <div class="col-md-10">
