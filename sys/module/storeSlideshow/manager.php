	...
	<div class="row">
		<div class="col-lg-9">
            ...
            <div class="form-group">
              ...
              <div class="col-md-10">
                <textarea name="html_content" class="form-control" maxlength="30" placeholder="詳細內容"><?php echo $row['html_content'];?></textarea>
                <span class="text-danger">字數限制30字</span>
              </div>
            </div>

            <div class="form-group">
              <label class="col-md-2 control-label" for="is_main">詳細內容啟用</label>
              <div class="col-md-10">
                <input style="width: 20px; height: 20px;" id="is_main" name="is_main" type="checkbox" value="1" <?php echo $check=$row['is_main']==1 ? 'checked' : ''; ?>  />
              </div>
            </div>
