           ...
           <div class="form-group">
            ...
            <div class="other_list_div">
              ...
              ?>
						...
						<div class="form-group">
							<label class="col-md-2 control-label" for="aAbstract"> 商品提醒</label>
							<div class="col-md-10">
								<textarea style="height: 200px;" class="form-control" name="aAbstract" ><?php echo $row['aAbstract'];?></textarea>
							</div>
						</div>
