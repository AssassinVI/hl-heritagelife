...
<?php
 ...
 if (!isset($_GET['OnLineOrNot'])) {
  ...
  $where=array('mt_id'=>$MT, 'OnLineOrNot'=>$_GET['OnLineOrNot']);
  $row_totle=pdo_select("SELECT COUNT(*) as totle FROM ".$tb_name." WHERE mt_id=:mt_id AND OnLineOrNot=:OnLineOrNot",$where);
 }
